namespace FuelTrack
{
    partial class Employees
    {
        ...
        private void InitializeComponent()
        {
            ...
            menubar_Employees.Controls.Add(rprt_label);
            menubar_Employees.Controls.Add(richTextBox1);
            menubar_Employees.Controls.Add(employee_btn);
            menubar_Employees.Controls.Add(suplier_btn);
            menubar_Employees.Controls.Add(manage_btn);
            menubar_Employees.Controls.Add(trans_btn);
            menubar_Employees.Controls.Add(main_label_menu);
            menubar_Employees.Controls.Add(inv_btn);
            menubar_Employees.Controls.Add(dashboard_btn);
            menubar_Employees.Controls.Add(fueltrack_icon);
            ...
            Employees_panel.Location = new Point(-2, -3);
            Employees_panel.Name = "Employees_panel";
            Employees_panel.Size = new Size(1271, 52);
            ...
            Controls.Add(menubar_Employees);
        ...
        private Panel menubar_Employees;
